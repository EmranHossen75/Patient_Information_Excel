...
namespace patientApi_01.Models
{
    ...
    public class PatientDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<NCD>().HasData(
                ...
                new Patient { PatientID = 1, PatientName = "John Doe", Epilepsy = Epilepsy.No, DiseaseID = 1 },
                new Patient { PatientID = 2, PatientName = "Jane Smith", Epilepsy = Epilepsy.Yes, DiseaseID = 2 }
