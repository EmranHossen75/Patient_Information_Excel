...
namespace patientApi_01.Migrations
{
    ...
    [Migration("20231109125748_modiA")]
    partial class modiA
    {
            ...
            modelBuilder.Entity("patientApi_01.Models.Allergies_Details", b =>
                {
                    ...
                    b.HasOne("patientApi_01.Models.Allergy", null)
            ...
            modelBuilder.Entity("patientApi_01.Models.NCD_Details", b =>
                {
                    ...
                    b.HasOne("patientApi_01.Models.NCD", null)
                        .WithMany("NCD_Details")
                        .HasForeignKey("NCDID1");
